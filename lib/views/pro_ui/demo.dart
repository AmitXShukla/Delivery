...
class _BubbleTabBarDemoState extends State<BubbleTabBarDemo> {
  ...
  void initState() {
    ...
    _navBarItems = [
      NavBarItemData("Ride", OMIcons.transitEnterexit, 110, Color(0xff01b87d)),
      NavBarItemData("Food", OMIcons.restaurant, 110, Color(0xff594ccf)),
      NavBarItemData("Delivery", OMIcons.playArrow, 115, Color(0xff09a8d9)),
      NavBarItemData("Serve", OMIcons.roomService, 100, Color(0xffcf4c7a)),
      NavBarItemData("Me", OMIcons.settings, 105, Color(0xfff2873f)),
    ];
